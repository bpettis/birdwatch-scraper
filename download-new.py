...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = os.environ.get("GCS_SERVICE_ACCOUNT") # set the specific creds json to the file that gcloud is expecting
...
def upload_blob(contents, destination_blob_name):
    ...
    blob.upload_from_string(contents, timeout=600)
